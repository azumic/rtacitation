    ...
    <div class="col-md">
        ...
        <div class="card shadow-sm p-3 mb-2 bg-white rounded">
            <div class="card-body">
                ...
                <small class="card-title text-muted">Violation Preview</small>
            ...
            <div class="row mt-2">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <th scope="row">{{view.violation_code}}</th>
                        <td>{{view.violation_name}}</td>
                        <td>
                            <i class='bx bx-pencil' style="cursor:pointer" v-on:click="edit_list(index,view.violation_code)"></i>
                            <i class='bx bx-trash-alt' style="cursor:pointer" v-on:click="delete_list(index,view.violation_code)"></i>
                        </td>
                        </tr>
...
var license = new Vue({
    ...
    methods:{
        ...
        async create__into (){
            ...
            const create_pending = await axios.get('<?php echo SITE_URL;?>/api/violation/createviolation.php?value='+`${this.value}`);
            ...
            switch(create_pending.status){
                ...
                case 200:
                    ...
                    if(stats.msg == "success"){
                        ...
                        this.last = this.last == null ? last.violation_code+1 : this.last+1;
                        this.preview.push({violation_code : this.last, violation_name: this.value.toLowerCase()});
        ...
        async Update__into (){
            ...
            const update_pending = await axios.get('<?php echo SITE_URL;?>/api/violation/updateviolation.php?value='+`${this.value}`+'&id='+`${this.toupdatekey}`);
            ...
            switch(update_pending.status){
                ...
                case 200:
                    ...
                    if(stats.msg == "success"){
                        ...
                        update.violation_name = this.value.toLowerCase();
        ...
        async Delete__into (id){
            ...
            const delete_pending = await axios.get('<?php echo SITE_URL;?>/api/violation/deleteviolation.php?value='+id);
        ...
        edit_list(index,key){
            ...
            this.value = edit.violation_name
    ...
    computed:{
        ...
        check_if_exist : function(){
            var Exist = this.preview.findIndex( s => s.violation_name == this.value.toLowerCase())
        ...
        searchlist() {
            if(this.search != ''){
                return this.preview.filter(list => {
                    ...
                    return list.violation_name.toLowerCase().includes(this.search.toLowerCase())
                })
            }else{
