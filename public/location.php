    ...
    <div class="col-md">
        ...
        <div class="card shadow-sm p-3 mb-2 bg-white rounded">
            <div class="card-body">
                ...
                <small class="card-title text-muted">Location Preview</small>
            ...
            <div class="row mt-2">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <th scope="row">{{view.location_code}}</th>
                        <td>{{view.location_name}}</td>
                        <td>
                            <i class='bx bx-pencil' style="cursor:pointer" v-on:click="edit_list(index,view.location_code)"></i>
                            <i class='bx bx-trash-alt' style="cursor:pointer" v-on:click="delete_list(index,view.location_code)"></i>
                        </td>
                        </tr>
...
var license = new Vue({
    ...
    methods:{
        ...
        async list () {
            const fetch_list = await axios.get('<?php echo SITE_URL;?>/api/location/viewlocation.php');
        ...
        async create__into (){
            ...
            const create_pending = await axios.get('<?php echo SITE_URL;?>/api/location/createlocation.php?value='+`${this.value}`);
            ...
            switch(create_pending.status){
                ...
                case 200:
                    ...
                    if(stats.msg == "success"){
                        ...
                        this.last = this.last == null ? last.location_code+1 : this.last+1;
                        this.preview.push({location_code : this.last, location_name: this.value.toLowerCase()});
        ...
        async Update__into (){
            ...
            const update_pending = await axios.get('<?php echo SITE_URL;?>/api/location/updatelocation.php?value='+`${this.value}`+'&id='+`${this.toupdatekey}`);
            ...
            switch(update_pending.status){
                ...
                case 200:
                    ...
                    if(stats.msg == "success"){
                        ...
                        update.location_name = this.value.toLowerCase();
        ...
        async Delete__into (id){
            ...
            const delete_pending = await axios.get('<?php echo SITE_URL;?>/api/location/deletelocation.php?value='+id);
    ...
    computed:{
        ...
        check_if_exist : function(){
            var Exist = this.preview.findIndex( s => s.location_name == this.value.toLowerCase())
        ...
        searchlist() {
            if(this.search != ''){
                return this.preview.filter(list => {
                    ...
                    return list.location_name.toLowerCase().includes(this.search.toLowerCase())
                })
            }else{
