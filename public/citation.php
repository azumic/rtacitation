    ...
    <div class="col-md">
        ...
        <div class="card shadow-sm p-3 mb-2 bg-white rounded">
            <div class="card-body">
                ...
                <small class="card-title text-muted">Citation Preview</small>
            ...
            <div class="row mt-2">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <th scope="row">{{view.cs_id}}</th>
                        <td>{{view.cs_status}}</td>
                        <td>
                            <i class='bx bx-pencil' style="cursor:pointer" v-on:click="edit_list(index,view.cs_id)"></i>
                            <i class='bx bx-trash-alt' style="cursor:pointer" v-on:click="delete_list(index,view.cs_id)"></i>
                        </td>
                        </tr>
...
var license = new Vue({
    ...
    methods:{
        ...
        async list () {
            const fetch_list = await axios.get('<?php echo SITE_URL;?>/api/citation/viewcitation.php');
        ...
        async create__into (){
            ...
            const create_pending = await axios.get('<?php echo SITE_URL;?>/api/citation/createcitation.php?value='+`${this.value}`);
            ...
            switch(create_pending.status){
                ...
                case 200:
                    ...
                    if(stats.msg == "success"){
                        ...
                        this.last = this.last == null ? last.cs_id+1 : this.last+1;
                        this.preview.push({cs_id : this.last, cs_status: this.value.toLowerCase()});
        ...
        async Update__into (){
            ...
            const update_pending = await axios.get('<?php echo SITE_URL;?>/api/citation/updatecitation.php?value='+`${this.value}`+'&id='+`${this.toupdatekey}`);
            ...
            switch(update_pending.status){
                ...
                case 200:
                    ...
                    if(stats.msg == "success"){
                        ...
                        update.cs_status = this.value.toLowerCase();
        ...
        async Delete__into (id){
            ...
            const delete_pending = await axios.get('<?php echo SITE_URL;?>/api/citation/deletecitation.php?value='+id);
    ...
    computed:{
        ...
        check_if_exist : function(){
            var Exist = this.preview.findIndex( s => s.cs_status == this.value.toLowerCase())
        ...
        searchlist() {
            if(this.search != ''){
                return this.preview.filter(list => {
                    ...
                    return list.cs_status.toLowerCase().includes(this.search.toLowerCase())
                })
            }else{
